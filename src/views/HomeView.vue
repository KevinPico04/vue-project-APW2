<template>
  <div>
    <nav>
      <router-link to="/home">Uleam</router-link>
      <router-link to="/">Cerrar Sesión</router-link>
    </nav>
    <h1>Bienvenido al Sistema Profesor</h1>
    <div id="contenedor">
      <!-- Imagen principal -->
    ...
    <div class="container">
      ...
      <router-link to="/agregar-tutoria" class="agregar-tutoria-link">Ver Tutorías</router-link>
    </div>
  </div>
</template>
